# scripts/run_fms_cash.py
# ---------------------------------------------------------------
# CLI entry point for the FMS cash (current-account) pipeline.
#
# Thin shell: parses argparse, sets up logging, dispatches to the
# run() wrappers in src/pipelines/positions/fms/cash/run.py.
#
# Usage:
#   python scripts/run_fms_cash.py --start-date 2026-06-22 --end-date 2026-06-22
#   python scripts/run_fms_cash.py --start-date 2026-06-01 --end-date 2026-06-30
#   python scripts/run_fms_cash.py --from-stg --batch-id fms_cash_20260622_081532
#   python scripts/run_fms_cash.py --start-date 2025-01-01 --end-date 2025-12-31 --force
#
# Flags:
...
from src.pipelines.positions.fms.cash.run import run_full, run_from_stg
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the FMS cash pipeline (extract, stage, fact-load)."
    )
...
if __name__ == "__main__":
    setup_logging('run_position_fms_cash')
    main()
