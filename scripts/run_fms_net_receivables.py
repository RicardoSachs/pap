# scripts/run_fms_net_receivables.py
# ---------------------------------------------------------------
# CLI entry point for the FMS net-receivables pipeline.
#
# Thin shell: parses argparse, sets up logging, dispatches to the run()
# wrappers in src/pipelines/positions/fms/net_receivables/run.py.
#
# Usage:
#   python scripts/run_fms_net_receivables.py --start-date 2026-08-27 --end-date 2026-08-27
#   python scripts/run_fms_net_receivables.py --start-date 2026-08-01 --end-date 2026-08-27
#   python scripts/run_fms_net_receivables.py --from-stg --batch-id fms_net_receivables_20260827_081532
#   python scripts/run_fms_net_receivables.py --start-date 2025-01-01 --end-date 2025-12-31 --force
#
# Flags:
...
from src.pipelines.positions.fms.net_receivables.run import run_full, run_from_stg
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the FMS net-receivables pipeline (extract, stage, fact-load)."
    )
...
if __name__ == "__main__":
    setup_logging('run_position_fms_net_receivables')
    main()
