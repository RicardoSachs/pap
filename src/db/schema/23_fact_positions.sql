...
CREATE INDEX IF NOT EXISTS ix_fact_positions_asof
    ON fact_positions (as_of_date);

CREATE INDEX IF NOT EXISTS ix_fact_positions_pf_date
    ON fact_positions (portfolio_id, as_of_date);

CREATE INDEX IF NOT EXISTS ix_fact_positions_sec
    ON fact_positions (security_entity_id);

CREATE INDEX IF NOT EXISTS ix_fact_positions_source
    ON fact_positions (source);
