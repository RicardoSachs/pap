...
CREATE INDEX IF NOT EXISTS ix_stg_positions_fms_batch
    ON stg_positions_fms (batch_id);

CREATE INDEX IF NOT EXISTS ix_stg_positions_fms_date
    ON stg_positions_fms (date);
